				...
				try{
					...
					if(res.code == 200){
						...
						if(this.islist == 1){
							setTimeout(()=>{
								uni.navigateTo({
									url:'./trainorderdetails?code=' + this.datalist.trano  + '&isck=false&vid=9&ist=9'
								})
							},1000)
						} else if(this.islist == 2){
							setTimeout(()=>{
								uni.navigateTo({
									url:'./traninchange/trainchanglist?code=' + this.datalist.trano  + '&isck=false&vid=11&ist=11'
								})
							},1000)
						}
